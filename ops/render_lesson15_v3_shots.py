#!/usr/bin/env python3
"""Render unique non-repeating H3 I2V shots for lesson 15 v3. One GPU at a time."""
...
def claim_first_frame(path: Path, shot_id: int) -> None:
    ...
    for store_path in (USED, GLOBAL_USED):
        ...
        data["used"][h] = {"shot": shot_id, "path": str(path), "lesson": 9}
