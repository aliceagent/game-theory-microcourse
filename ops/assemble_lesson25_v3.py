#!/usr/bin/env python3
"""Assemble lesson 25 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    return render_title_card(
        ...
        TITLE_PNG,
        25,
        ["Mobility routes and", "the role of luck"],
    )
