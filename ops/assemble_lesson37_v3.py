#!/usr/bin/env python3
"""Assemble lesson 37 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    return render_title_card(
        ...
        TITLE_PNG,
        37,
        ["Inherited advantage", "and the closing ladder"],
    )
