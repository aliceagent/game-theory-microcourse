#!/usr/bin/env python3
"""Assemble lesson 24 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    return render_title_card(
        ...
        TITLE_PNG,
        24,
        ["Leaving, safety and", "high-risk routes"],
    )
