#!/usr/bin/env python3
"""Assemble lesson 40 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    return render_title_card(
        ...
        TITLE_PNG,
        40,
        ["Why the cycle returns:", "inheritance and schools"],
    )
