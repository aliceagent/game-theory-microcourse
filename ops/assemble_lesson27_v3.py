#!/usr/bin/env python3
"""Assemble lesson 27 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    return render_title_card(
        ...
        TITLE_PNG,
        27,
        ["Strategy, traits and", "luck together"],
    )
