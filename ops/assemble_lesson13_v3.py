#!/usr/bin/env python3
"""Assemble lesson 13 v3: unique monotonic shots, no picture loop, duration = narration."""
...
def make_title() -> Path:
    ...
    tab = (290, 88, 640, 248)
    tab_fill(tab, TEAL)
    x, y = ink_center(fb, "LESSON 13", tab)
    ImageDraw.Draw(img).text((x, y), "LESSON 13", font=fb, fill=PAPER)
    ...
    lines = [
        (ft, "Rational adaptation", SLATE),
        (fs, "and resilience", TEAL),
    ]
